...
// DEBUG board, LED connected to GPIOC(13) and VCC (not GND)
/*
#define HW_LED1_BIT   (13)
#define HW_LED1_PORT  GPIOC
#define HW_LED1_INIT  GPIO_PIN_INIT(HW_LED1_PORT, HW_LED1_BIT, GPIO_MODE_OUTPUT)
#define HW_LED1_ON    {GPIO_BIT_CLR(HW_LED1_PORT, HW_LED1_BIT); GPIO_MODE(HW_LED1_PORT, HW_LED1_BIT, GPIO_MODE_OUTPUT);}
#define HW_LED1_OFF   GPIO_MODE(HW_LED1_PORT, HW_LED1_BIT, GPIO_MODE_FLOATING) 
*/
...
#define HW_SPI_SW_SCK_BIT   (5)
#define HW_SPI_SW_SCK_PORT  GPIOA
#define HW_SPI_SW_SCK_INIT  GPIO_PIN_INIT(HW_SPI_SW_SCK_PORT,HW_SPI_SW_SCK_BIT,GPIO_MODE_OUTPUT)
#define HW_SPI_SW_SCK_UP    GPIO_BIT_SET(HW_SPI_SW_SCK_PORT,HW_SPI_SW_SCK_BIT)
#define HW_SPI_SW_SCK_DOWN  GPIO_BIT_CLR(HW_SPI_SW_SCK_PORT,HW_SPI_SW_SCK_BIT)

#define HW_SPI_SW_MISO_BIT  (6)
#define HW_SPI_SW_MISO_PORT GPIOA
#define HW_SPI_SW_MISO_INIT GPIO_PIN_INIT(HW_SPI_SW_MISO_PORT, HW_SPI_SW_MISO_BIT,GPIO_MODE_INPUT)
#define HW_SPI_SW_MISO_IN   GPIO_IN(HW_SPI_SW_MISO_PORT, HW_SPI_SW_MISO_BIT)

#define HW_SPI_SW_MOSI_BIT  (7)
#define HW_SPI_SW_MOSI_PORT GPIOA
#define HW_SPI_SW_MOSI_INIT GPIO_PIN_INIT(HW_SPI_SW_MOSI_PORT, HW_SPI_SW_MOSI_BIT, GPIO_MODE_OUTPUT)
#define HW_SPI_SW_MOSI_UP   GPIO_BIT_SET(HW_SPI_SW_MOSI_PORT,HW_SPI_SW_MOSI_BIT)
#define HW_SPI_SW_MOSI_DOWN GPIO_BIT_CLR(HW_SPI_SW_MOSI_PORT,HW_SPI_SW_MOSI_BIT)
*/
...
#define HW_VCC_RESET_SET     {GPIO_BIT_SET(HW_VCC_RESET_PORT, HW_VCC_RESET_BIT); GPIO_MODE(HW_VCC_RESET_PORT, HW_VCC_RESET_BIT, GPIO_MODE_OUTPUT);}
#define HW_VCC_RESET_CLR     GPIO_MODE(HW_VCC_RESET_PORT, HW_VCC_RESET_BIT, GPIO_MODE_FLOATING)
