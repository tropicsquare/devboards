# TS1302 – USB Devkit (Revision 2.0)

KiCad-based hardware project providing a development platform for the TROPIC01 chip via USB interface.

## Features

- **USB-C interface** with STM32U5 microcontroller (256kB)
- **Firmware**: [Firmware A](./../../legacy_fw/firmware_B/README.md) acts as USB-to-SPI converter for host communication with TROPIC01
